...
const Avatar = ({ src, name }: AvatarProps) => {
  return (
    ...
    >
      <div className="opacity-0 group-hover:opacity-100 absolute top-full py-1 px-2 text-white text-xs rounded-lg mt-2.5 z-10 bg-black whitespace-normal transition-opacity">
        {name}
      </div>
